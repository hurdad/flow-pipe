...
type StageSpec struct {
	...
	RealtimePriority *uint32 `protobuf:"varint,7,opt,name=realtime_priority,json=realtimePriority,proto3,oneof" json:"realtime_priority,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
const file_flowpipe_v1_flow_proto_rawDesc = "" +
	...
	"\tExecution\x12.\n" +
	"\x04mode\x18\x01 \x01(\x0e2\x1a.flowpipe.v1.ExecutionModeR\x04mode\"\xb5\x02\n" +
	"\tStageSpec\x12\x12\n" +
	...
	"\x06config\x18\x06 \x01(\v2\x17.google.protobuf.StructR\x06config\x120\n" +
	"\x11realtime_priority\x18\a \x01(\rH\x02R\x10realtimePriority\x88\x01\x01B\x0e\n" +
	"\f_input_queueB\x0f\n" +
	"\r_output_queueB\x14\n" +
